...
{
    LogInfo<< "Function Task::initialize() say hello." <<std::endl;
...
bool Task::finalize()
{
    LogDebug<< "Function Task::finalize() say hello." <<std::endl; 
